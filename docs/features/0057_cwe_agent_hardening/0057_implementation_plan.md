...
| P5c | `promote_signatures.py` (data-driven candidate↔trusted) | **add** `scripts/promote_signatures.py` | M |
...
- ☐ `VERIFIED_CWES.md` generated by CI; **N reproducible** via `pytest agents/cwe/tests/corpus/`; stale → CI fail.
